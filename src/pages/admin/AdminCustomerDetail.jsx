            ...
            {customer?.note && customer.note.length > 0 ? (
              [...customer.note].reverse().map((note, index) => (
                ...
                >
                  ...
                  <p className="text-[11px] font-light text-slate-600 dark:text-slate-400 bg-slate-50/40 dark:bg-slate-950/10 p-2.5 border border-slate-100 dark:border-slate-800/60 leading-relaxed wrap-break-words">
                    {note.content}
                  </p>
                </div>
              ))
