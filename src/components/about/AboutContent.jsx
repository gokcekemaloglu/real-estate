...
const AboutContent = () => {
  return (
    <div className="flex flex-col gap-6 text-slate-600 dark:text-slate-300 font-light leading-relaxed text-sm md:text-base">
      ...
      <p>
        Görkem Emlak, kurulduğu günden bu yana lüks konut, elite projeler ve
        sıra dışı yaşam alanlarını seçkin yatırımcılarla buluşturmayı misyon
        edinmiştir. Sadece bir gayrimenkul ofisi değil, yaşam tarzı mimarı
        olarak hizmet veriyoruz.
      </p>

      <p className="border-l-2 border-brand-gold pl-4 italic text-slate-500 dark:text-slate-400">
        "Her portföy bir sanat eseri, her müşteri ise benzersiz bir hikayedir.
        Biz, o hikayelere en kusursuz mekanları inşa etmek için buradayız." —
        Cemal Ciğer
      </p>

      <p>
        Küresel standartlarda sunduğumuz analizler, şeffaf süreç yönetimi ve
        kişiselleştirilmiş danışmanlık hizmetlerimizle, yatırım kararlarınızı
        sanata ve kalıcı bir mirasa dönüştürüyoruz.
      </p>
