...
const HomeServices = () => {
  const services = [
    {
      ...
      description: "Adana, Mersin ve civar bölgelerini karış karış biliyoruz. Hak ettiğiniz doğru, dürüst ve ailenizin bütçesine tam uyumlu gayrimenkul danışmanlığını sunuyoruz.",
      icon: (
    ...
    {
      id: 2,
      title: "Her Bütçeye Uygun Geniş İlan Ağı",
      description: "Sadece belirli mülkleri değil; her bütçeden uygun fiyatlı kiralık evleri, satılık daireleri ve yatırımlık arsaları portföyümüzde bulunduruyoruz..",
      icon: (
        <svg className="w-6 h-6 text-brand-gold" fill="none" stroke="currentColor" strokeWidth="1" viewBox="0 0 24 24">
    ...
    {
      id: 3,
      title: "Şeffaf Sözleşme & Tapu Güvencesi",
      description: "Alım, satım ve kiralama süreçlerinizin her aşamasında, yasal mevzuatlara tam uyumlu, iki tarafın da haklarını koruyan dürüst ve şeffaf bir aracılık sağlıyoruz.",
      icon: (
        <svg className="w-6 h-6 text-brand-gold" fill="none" stroke="currentColor" strokeWidth="1" viewBox="0 0 24 24">
  ...
  return (
    <section className="py-20 bg-white dark:bg-brand-dark transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[14vw] font-serif italic font-extrabold text-slate-400/10 dark:text-white/5 pointer-events-none select-none tracking-widest uppercase text-center">
        Görkem <br /> Emlak
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <h2 className="text-3xl md:text-4xl font-light tracking-tight text-slate-900 dark:text-white font-serif">
            Gayrimenkulde Güvenilir <span className="italic text-brand-gold dark:text-amber-400">Hizmet Standartları</span>
          </h2>
