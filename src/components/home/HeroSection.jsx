  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-slate-50 dark:bg-brand-dark overflow-hidden font-display transition-colors duration-300">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center flex flex-col items-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-light tracking-tight text-slate-900 dark:text-white mb-6 leading-tight max-w-4xl transition-colors duration-300">
          Sıra Dışı Yaşam Alanlarını <br />
          <span className="font-serif italic text-brand-gold dark:text-amber-400">Keşfedin</span>
        </h1>
        
        <p className="text-sm md:text-base text-slate-500 dark:text-slate-400 max-w-xl font-light mb-10 leading-relaxed transition-colors duration-300">
      ...
      <div className="absolute -bottom-48 -right-48 w-96 h-96 bg-brand-gold/5 dark:bg-brand-gold/10 blur-[120px] rounded-full transition-colors duration-300"></div>
